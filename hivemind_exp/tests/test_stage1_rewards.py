...
class TestStage1Rewards(unittest.TestCase):
    ...
    def test_extract_xml_answer(self):
        ...
        self.assertEqual(extract_xml_answer("Some text <answer>456</answer> more text"), "456")
        # Edge cases
    ...
    def test_correctness_reward_func(self):
        ...
        rewards1 = correctness_reward_func(
            self.mock_prompts, [self.mock_completions[0]], self.mock_answer, weighting=2.0
        )
        rewards2 = correctness_reward_func(
            self.mock_prompts, [self.mock_completions[1]], self.mock_answer, weighting=2.0
        )
        rewards3 = correctness_reward_func(
            self.mock_prompts, [self.mock_completions[2]], self.mock_answer, weighting=2.0
        )
    ...
    def test_top_k_cumulative_reward(self):
        ...
        with patch('hivemind_exp.gsm8k.stage1_rewards.correctness_reward_func') as mock_correctness, \
             patch('hivemind_exp.gsm8k.stage1_rewards.int_reward_func') as mock_int, \
             patch('hivemind_exp.gsm8k.stage1_rewards.strict_format_reward_func') as mock_strict, \
             patch('hivemind_exp.gsm8k.stage1_rewards.soft_format_reward_func') as mock_soft, \
    ...
    def test_hivemind_cumulative_reward(self):
        ...
        with patch('hivemind_exp.gsm8k.stage1_rewards.correctness_reward_func') as mock_correctness, \
            ...
            rewards = hivemind_cumulative_reward(
                ...
                self.mock_answer, output_signal_selector="max"
            )
            ...
            self.assertEqual(mock_node.outputs["agent_answers"][mock_node.key], self.sample_text_good)
            ...
            with patch('hivemind_exp.gsm8k.stage1_rewards.correctness_reward_func') as mock_correctness, \
                ...
                rewards = hivemind_cumulative_reward(
                    mock_node, self.mock_prompts, self.mock_completions, 
                    self.mock_answer, output_signal_selector=None
                )
