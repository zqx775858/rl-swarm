...
Which student's answer is correct? Analyze each answer carefully."""
    ...
    def test_extract_xml_identity(self):
        ...
        self.assertEqual(extract_xml_identity("<identify>student2</identify>"), "student2")
        self.assertEqual(extract_xml_identity("Some text <identify>student3</identify> more text"), "student3")
        # Edge cases
    ...
    def test_proper_id_reward_func(self):
        ...
        rewards2 = proper_id_reward_func(
            self.mock_prompts, [self.mock_completions[1]], self.mock_answer, weighting=2.0, logging=False
        )
        rewards3 = proper_id_reward_func(
            self.mock_prompts, [self.mock_completions[2]], self.mock_answer, weighting=2.0, logging=False
        )
        ...
        invalid_completion = [[{"content": "<identify>\ninvalid_student\n</identify>\n"}]]
        rewards_invalid = proper_id_reward_func(
            self.mock_prompts, invalid_completion, self.mock_answer, weighting=2.0, logging=False
        )
    ...
    def test_correctness_reward_func(self):
        ...
        with patch('hivemind_exp.gsm8k.stage1_rewards.extract_xml_answer') as mock_extract, \
            ...
            with patch('hivemind_exp.gsm8k.stage2_rewards.extract_answers') as mock_answers:
    ...
    def test_top_k_cumulative_reward(self):
        ...
        with patch('hivemind_exp.gsm8k.stage2_rewards.proper_id_reward_func') as mock_proper_id, \
             patch('hivemind_exp.gsm8k.stage2_rewards.correctness_reward_func') as mock_correctness, \
             patch('hivemind_exp.gsm8k.stage2_rewards.strict_format_reward_func') as mock_strict, \
             patch('hivemind_exp.gsm8k.stage2_rewards.soft_format_reward_func') as mock_soft, \
            ...
            rewards = top_k_cumulative_reward(
                self.mock_prompts, self.mock_completions, self.mock_answer, logging=False
            )
    ...
    def test_hivemind_cumulative_reward(self):
        ...
        with patch('hivemind_exp.gsm8k.stage2_rewards.proper_id_reward_func') as mock_proper_id, \
             ...
             patch('hivemind_exp.gsm8k.stage2_rewards.soft_format_reward_func') as mock_soft, \
             patch('hivemind_exp.gsm8k.stage2_rewards.xmlcount_reward_func') as mock_xml, \
             patch('hivemind_exp.gsm8k.stage2_rewards.extract_original_question') as mock_extract:
            ...
            self.assertEqual(mock_node.outputs["agent_opinion"][mock_node.key], self.sample_text_good)
